        ...
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8" aria-label="التنقل الرئيسي">
          <div className="flex h-18 items-center justify-between py-4">
            ...
            <div className="hidden lg:flex lg:items-center lg:gap-3">
              ...
              <Link
                href="/ar/account"
                className="text-warm-600 hover:text-primary-600 transition-colors p-2"
                title="حسابي"
              >
            ...
            <div className="lg:hidden py-4 border-t border-warm-100">
              ...
              <div className="mt-5 pt-5 border-t border-warm-100 space-y-4">
                <Link
                  href="/ar/account"
                  onClick={() => setMobileMenuOpen(false)}
                  className="w-full bg-warm-100 text-warm-700 py-3.5 rounded-xl font-medium flex items-center justify-center gap-2"
                >
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                  </svg>
