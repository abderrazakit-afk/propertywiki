...
export const metadata: Metadata = {
  ...
  description: 'Complete guide to renting property in the UAE. Learn about Ejari, tenancy contracts, tenant rights, security deposits, and rental regulations.',
  ...
  openGraph: {
    ...
    title: 'How to Rent Property in UAE - Complete Tenant\'s Guide',
    description: 'Everything you need to know about renting property in Dubai and across the UAE.',
    type: 'article',
        ...
        <nav className="mt-12 pt-8 border-t border-warm-200" aria-label="Explore more">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/locations/dubai/jbr" className="block p-4 bg-warm-50 rounded-xl hover:bg-warm-100 transition-colors">
              <span className="text-xs font-medium text-primary-600 uppercase">Location</span>
              <p className="font-medium text-gray-900 mt-1">JBR</p>
            </Link>
            ...
            <Link href="/definitions/leasehold" className="block p-4 bg-warm-50 rounded-xl hover:bg-warm-100 transition-colors">
              ...
              <p className="font-medium text-gray-900 mt-1">Leasehold Property</p>
            </Link>
