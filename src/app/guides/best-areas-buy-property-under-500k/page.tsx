      ...
      <article className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="mt-12 pt-8 border-t border-warm-200" aria-label="Explore more">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/guides/where-to-buy-under-1-million-dubai" className="block p-4 bg-warm-50 rounded-xl hover:bg-warm-100 transition-colors">
              <span className="text-xs font-medium text-primary-600 uppercase">Guide</span>
              <p className="font-medium text-gray-900 mt-1">Where to Buy Under 1 Million AED</p>
            </Link>
