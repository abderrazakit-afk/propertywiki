    ...
    <div className="bg-white min-h-screen">
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <section className="mt-12 pt-8 border-t border-warm-200">
          <h2 className="text-2xl font-serif font-semibold text-gray-900 mb-6">موارد مفيدة</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/ar/guides" className="group luxury-card p-5">
              <span className="inline-block text-xs font-medium text-primary-600 uppercase tracking-wider mb-2">أدلة</span>
              <h3 className="text-lg font-medium text-gray-900 group-hover:text-primary-600 transition-colors mb-2">أدلة العقارات</h3>
              <p className="text-sm text-gray-600 line-clamp-2">خطوة بخطوة للشراء والبيع والإيجار.</p>
            </Link>
            <Link href="/ar/locations/dubai" className="group luxury-card p-5">
              <span className="inline-block text-xs font-medium text-primary-600 uppercase tracking-wider mb-2">مناطق</span>
              <h3 className="text-lg font-medium text-gray-900 group-hover:text-primary-600 transition-colors mb-2">مجتمعات دبي</h3>
              <p className="text-sm text-gray-600 line-clamp-2">استكشف الأحياء والمناطق الشهيرة.</p>
            </Link>
            <Link href="/ar/definitions" className="group luxury-card p-5">
              <span className="inline-block text-xs font-medium text-primary-600 uppercase tracking-wider mb-2">مصطلحات</span>
              <h3 className="text-lg font-medium text-gray-900 group-hover:text-primary-600 transition-colors mb-2">المصطلحات العقارية</h3>
              <p className="text-sm text-gray-600 line-clamp-2">شروحات واضحة للمفاهيم العقارية.</p>
            </Link>
          </div>
        </section>
