        ...
        <nav className="mt-10 pt-8 border-t border-warm-200" aria-label="استكشف المزيد">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/ar/guides/hidden-costs-buying-property-dubai" className="block p-4 bg-warm-50 rounded-xl hover:bg-warm-100 transition-colors">
              ...
              <p className="font-medium text-gray-900 mt-1">التكاليف الخفية لشراء عقار</p>
            </Link>
            <Link href="/ar/guides/dld-fees-calculator-guide" className="block p-4 bg-warm-50 rounded-xl hover:bg-warm-100 transition-colors">
              <span className="text-xs font-medium text-primary-600 uppercase">دليل</span>
              <p className="font-medium text-gray-900 mt-1">دليل رسوم دائرة الأراضي</p>
            </Link>
            <Link href="/ar/guides/maintenance-cost-by-community-dubai" className="block p-4 bg-warm-50 rounded-xl hover:bg-warm-100 transition-colors">
              <span className="text-xs font-medium text-primary-600 uppercase">دليل</span>
              <p className="font-medium text-gray-900 mt-1">تكاليف الصيانة حسب المجتمع</p>
            </Link>
          </div>
        </nav>
