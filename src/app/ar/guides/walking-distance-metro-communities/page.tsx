      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
        ...
        <nav className="mt-10 pt-8 border-t border-warm-200" aria-label="استكشف المزيد">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Link href="/ar/guides/property-near-red-line-metro-dubai" className="block p-4 bg-warm-50 rounded-xl hover:bg-warm-100 transition-colors">
              <span className="text-xs font-medium text-primary-600 uppercase">دليل</span>
              <p className="font-medium text-gray-900 mt-1">عقارات قرب الخط الأحمر لمترو دبي</p>
            </Link>
